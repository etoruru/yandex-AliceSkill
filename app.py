...
ABOUT = """ Добро пожаловать! Чтобы узнать расписание на сегодня, скажите "Какие сегодня пары", 
...
GREETING = """ Добро пожаловать! Здесь вы можете узнать свое расписание пар, сказав "Какие сегодня пары?" или "Какое расписание на понедельник?" 
...
def create_response(payload):
    ...
    phrase = 'Извините, я вас не понимаю. ' \
